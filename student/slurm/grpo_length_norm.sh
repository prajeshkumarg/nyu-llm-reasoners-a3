...
#SBATCH --requeue
#SBATCH --array=0-1
#SBATCH --output=./logs/grpo_length_%A_%a.out
#SBATCH --error=./logs/grpo_length_%A_%a.err
...
LENGTH_NORMS=("masked_mean" "masked_normalize")
LENGTH_NORM=${LENGTH_NORMS[$SLURM_ARRAY_TASK_ID]}
...
uv run python student/grpo_train.py \
    ...
    --output-dir /scratch/pg2973/grpo_length_${LENGTH_NORM} \
    --n-grpo-steps 200 \
